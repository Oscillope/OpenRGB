...
OpenRGBDialog2::OpenRGBDialog2(std::vector<i2c_smbus_interface *>& bus, std::vector<RGBController *>& control, std::vector<FanController *>& fancontrol, ProfileManager* manager, NetworkServer* server, bool show_i2c_tools, QWidget *parent) : QMainWindow(parent), busses(bus), controllers(control), fan_controllers(fancontrol), profile_manager(manager), network_server(server), ui(new OpenRGBDialog2Ui)
{
    ui->setupUi(this);
